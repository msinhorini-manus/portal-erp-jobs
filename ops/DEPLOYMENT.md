...
Para rollback da primeira migração regional, pare API e Next, preserve a base pós-incidente e restaure o snapshot SQLite feito imediatamente antes do upgrade. O downgrade Alembic foi validado em banco descartável, mas não deve substituir o restore transacional em produção.
