...
export default function CandidateRegisterPage() {
  ...
  // Sincronizar valores do DOM com o estado do React
  const syncFormData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Sincronizar dados do formulário antes de validar
    const currentData = syncFormData()
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {isSubmitting ? 'Criando conta...' : 'Criar Conta e Montar Currículo'}
