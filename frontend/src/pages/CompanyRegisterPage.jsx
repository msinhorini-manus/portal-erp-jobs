                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        value={watchedSector || ''}
                        onChange={(e) => {
                          setValue('sector', e.target.value, { shouldValidate: true, shouldDirty: true })
                        }}
                        className="w-full px-3 py-2.5 border-2 rounded-md focus:border-[#F7941D] focus:outline-none h-11 bg-white"
                      >
                      ...
                      <input type="hidden" {...register('sector', { required: true })} />
                      {errors.sector && (
                        <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        value={watchedSize || ''}
                        onChange={(e) => {
                          setValue('companySize', e.target.value, { shouldValidate: true, shouldDirty: true })
                        }}
                        className="w-full px-3 py-2.5 border-2 rounded-md focus:border-[#F7941D] focus:outline-none h-11 bg-white"
                      >
                      ...
                      <input type="hidden" {...register('companySize', { required: true })} />
                      {errors.companySize && (
                        <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>
                      )}
                    </div>
