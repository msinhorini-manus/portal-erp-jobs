...
export const authAPI = {
  ...
  loginAdmin: async (credentials) => {
    return fetchAPI('/auth/login/admin', {
      method: 'POST',
      body: JSON.stringify(credentials),
    });
  },
   ...
   * Login with Google
   */
  socialGoogle: async (token) => {
    return fetchAPI('/auth/social/google', {
      method: 'POST',
   ...
   * Login with LinkedIn
   */
  socialLinkedIn: async (code, redirectUri) => {
    return fetchAPI('/auth/social/linkedin', {
      method: 'POST',
...
// ==================== RESUME API OBJECT ====================
// ============================================
// CONFIG ENDPOINTS (Areas, Levels, Modalities, etc.)
// ============================================
...
export const configAPI = {
  ...
  /**
   * Get all softwares/ERPs
   */
  getSoftwares: async () => {
    return fetchAPI('/config/softwares');
  },
  ...
  updateArea: async (id, data) => {
    return fetchAPI(`/config/areas/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
  },
